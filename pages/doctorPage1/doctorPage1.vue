	...
	<view class="container">
		...
		<view class="form">
			<u-form :model="form" ref="uForm" :errorType="['toast']">
				<u-form-item label="医生手机号码:" class="uitem" label-width="auto" :border-bottom="false" prop="doctorTel"
					:label-style="{'font-size':'24rpx','font-family':'Alibaba PuHuiTi','font-weight': 400,'color': '#808080'}">
					<u-input v-model="form.doctorTel" class="uinput" placeholder="请输入" :autoHeight="false"
						maxlength="11" />
				</u-form-item>
			</u-form>
			<!-- 提交按钮 -->
